...
const buttonVariants = cva(
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 disabled:bg-muted disabled:text-muted-foreground border border-border shadow-sm",
  {
    variants: {
      variant: {
        primary:
        ...
        muted: "bg-neutral-200 text-neutral-600 hover:bg-neutral-200/80 border-transparent",
        tertiary:
